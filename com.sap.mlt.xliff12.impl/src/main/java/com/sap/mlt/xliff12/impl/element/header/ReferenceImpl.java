...
public class ReferenceImpl extends XliffElementImpl implements Reference {

	public ReferenceImpl(Child child) {
		super(NAME);
		setChild(child);
	}

	public ReferenceImpl(org.w3c.dom.Element elem)
	...
	protected void cloneChildrenFrom(ElementImpl elem) {
		ReferenceImpl source = (ReferenceImpl) elem;
