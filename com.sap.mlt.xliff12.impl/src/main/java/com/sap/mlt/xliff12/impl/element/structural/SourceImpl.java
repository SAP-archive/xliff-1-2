...
public class SourceImpl extends XliffElementImpl implements Source {

	public SourceImpl(List<? extends TextFragment> content) {
		super(NAME);
		setContent(content);
	}

	public SourceImpl(Element element) throws ConstraintViolationException {
		super(NAME, element);
	}
	...
	protected void cloneChildrenFrom(ElementImpl elem) {
		SourceImpl source = (SourceImpl) elem;
