...
/**
 * Source text - The SegSource element is used to maintain a working copy of the
 * {@link Source} element, where markup such as segmentation can be introduced
 * without affecting the actual {@link Source} element content. The content of
 * the SegSource is generally the translatable text, typically divided into
 * segments through the use of {@link Mrk} elements. As with the {@link Source}
 * element, the optional {@link XmlLang} attribute is used to specify the
 * content language of the SegSource; this should always match
 * {@link SourceLanguage} as a child of {@link TransUnit} but can vary as a
 * child of {@link AltTrans}. The optional
 * {@link com.sap.mlt.xliff12.api.attribute.Ts} attribute was DEPRECATED in
 * XLIFF 1.1.
 * 
 * @author D049314
 */
public interface SegSource extends XliffElement {

	/**
	 * The element's name.
	 */
	static final String NAME = "seg-source";
