...
/**
 * Isolated tag - The It element is used to delimit a beginning/ending sequence
 * of native codes that does not have its corresponding ending/beginning within
 * the translation unit. The required {@link Id} attribute is used to identify
 * the It inline code. The required {@link Pos} attribute specifies whether this
 * is the begin or end code. The optional {@link CtypeDelim} attribute allows
 * you to specify what kind of attribute the code represents. The optional
 ...
 * @author D049314
 */
public interface It extends InlineBase, TextFragment {
	...
	/**
	 * Returns the <code>Pos</code> attribute.
	 * 
	 * @return Returns the <code>Pos</code> attribute.
	 */
	Pos getPos();

	/**
	 * Sets the <code>Pos</code> attribute.
	 * 
	 * @param pos
	 *            The <code>Pos</code> attribute. Must not be <code>null</code>.
	 */
	void setPos(Pos pos);
